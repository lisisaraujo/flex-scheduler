    ...
    <div className="overflow-hidden rounded-[1rem] border border-white/45 bg-[linear-gradient(180deg,rgba(255,255,255,0.74),rgba(255,255,255,0.56))] shadow-[inset_0_1px_0_rgba(255,255,255,0.7),0_24px_60px_rgba(15,23,42,0.10)] backdrop-blur-2xl">
      ...
      {rows.map((row) => (
        ...
        >
          ...
          <div className="border-r border-white/55 px-4 py-4 text-center text-zinc-700">{row.night[0] ?? ""}</div>
          <div className="border-r border-zinc-300/80 bg-zinc-50/35 px-4 py-4 text-center text-zinc-700 shadow-[inset_-1px_0_0_rgba(255,255,255,0.5)]">
            {row.night[1] ?? ""}
          </div>
          <div className="border-r border-white/55 px-4 py-4 text-center text-zinc-700">{row.weekend ? row.day[0] ?? "" : ""}</div>
          <div className="px-4 py-4 text-center text-zinc-700">{row.weekend ? row.day[1] ?? "" : ""}</div>
        </div>
      ))}
    </div>
  );
